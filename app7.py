...
def main():
    ...
    # Advanced Search Mode
        ...
        brokerage = st.sidebar.multiselect(
            "Select options", 
            ["Yes", "No"], 
            key="brokerage",
            placeholder="Select brokerage options"
        )
        
        # 5. Property ID
        st.sidebar.markdown("5. **Property ID**")
        property_id = st.sidebar.text_input("Enter ID", key="property_id", placeholder="Enter property ID")
        ...
        furnishing = st.sidebar.multiselect(
            ...
            key="furnishing",
            placeholder="Select furnishing options"
        )
        ...
        area = st.sidebar.multiselect(
            ...
            areas, 
            key="area",
            placeholder="Select area options"
        )
        ...
        zone = st.sidebar.multiselect(
            ...
            zones, 
            key="zone",
            placeholder="Select zone options"
        )
        
        # 11. Floor Number
        st.sidebar.markdown("11. **Floor Number**")
        floor_no = st.sidebar.multiselect(
            "Select options", 
            floor_nos, 
            key="floor_no",
            placeholder="Select floor number options"
        )
        ...
        property_type = st.sidebar.multiselect(
            ...
            property_types, 
            key="property_type",
            placeholder="Select property type options"
        )
        ...
        ownership = st.sidebar.multiselect(
            ...
            ownerships, 
            key="ownership",
            placeholder="Select ownership options"
        )
        
        # 15. Possession Status
        st.sidebar.markdown("15. **Possession Status**")
        possession_status = st.sidebar.multiselect(
            "Select options", 
            possession_statuses, 
            key="possession_status",
            placeholder="Select possession status options"
        )
        
        # 16. Location Hub
        st.sidebar.markdown("16. **Location Hub**")
        location_hub = st.sidebar.multiselect(
            "Select options", 
            location_hubs, 
            key="location_hub",
            placeholder="Select location hub options"
        )
        ...
        selected_facilities = st.sidebar.multiselect(
            ...
            facilities, 
            key="facilities",
            placeholder="Select facility options"
        )
